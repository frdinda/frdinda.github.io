            ...
            <div class="auth-box row">
                <div class="col-lg-12 col-md-12 bg-white">
                    <div class="p-3">
                        ...
                        <form class="mt-4 login" id="login" action="<?= base_url('/7m4e'); ?>" method="post">
                            <div class="row">
                                <div class="col-lg-12">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <input class="form-control" id="no_telp" name="no_telp" type="number" placeholder="nomor telepon" required>
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="form-group">
                                ...
                                <div class="col-lg-12 text-center mt-5">
                                    Sudah memiliki akun? <a href="<?= base_url('/pelantikan') ?>" class="text-danger">Login</a>
                                </div>
                            </div>
                        </form>
                    </div>
