        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                <table id="zero_config" class="table table-hover table-bordered no-wrap display">
                    ...
                    <tbody>
                        <?php $nomor = 0;
                        foreach ($all_pelantikan as $m) : if ($m['jenis_permohonan'] == 'notaris pengganti') { ?>
                                <tr>
                                    ...
                                    <td><?php if (isset($m['tanggal_pelantikan'])) {
                                            $tanggal_pelantikan = date("d-m-Y", strtotime($m['tanggal_pelantikan']));
                                            $hari_input = date("D", strtotime($m['tanggal_pelantikan']));
                                            if ($hari_input == 'Mon') {
                                                $hari_input = 'Senin';
                                                $tanggal_pelantikan = $hari_input . ", " . $tanggal_pelantikan;
                                                echo $tanggal_pelantikan;
                                            } else if ($hari_input == 'Tue') {
                                                $hari_input = 'Selasa';
                                                $tanggal_pelantikan = $hari_input . ", " . $tanggal_pelantikan;
                                                echo $tanggal_pelantikan;
                                        ...
                                        <td>
                                            ...
                                            <?php } else { ?>
                                                <a href="<?php $code = $m['dokumen_permohonan'];
                                                            echo base_url('/vpln/' . $code); ?>" class="btn btn-block btn-dark">Proses</a>
                                            <?php } ?>
                                        </td>
                                    <?php } ?>
                                </tr>
